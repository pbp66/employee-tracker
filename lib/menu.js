...
export default class Menu {
    ...
    async menuSelection(selection) {
     ...
     async departmentPrompts() {
        ...
        switch(response) {
            case('view all'):
                return await interfaceObj.viewAllDepartments();
            case('view budget'):
                return await this.getUserInput(interfaceObj, 'view budget');
            case('add'):
                return await this.getUserInput(interfaceObj, 'add');
            default:
                ...
                switch(method) {
                    ...
                    case('update'):
                        ...
                        }, 
                        {
                            ...
                            choices: await this.deptConn.getAllDepartmentNames();
                            when: function( answer ) {
                                return answer['Attribute'] === 'Department';
                            }
                        });
